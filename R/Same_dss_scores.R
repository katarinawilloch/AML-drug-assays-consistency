...
dss_github_enserink <- read_csv('~/Desktop/UiO/Project 1/Data/Initial cleansing/dss_github_enserink.csv') #'~/Desktop/UiO/Project 1/Data/Initial cleansing/dss_github_enserink_full_drug_set_testing.csv'
...
compare_dss2_github_enserink <- subset(dss_github_enserink_full_set_drugs, select = c(Patient.num, drug, DSS2))
compare_dss2_github_enserink <- compare_dss2_github_enserink %>% arrange(desc(Patient.num), .by_group = FALSE)
compare_dss2_github_enserink <- compare_dss2_github_enserink %>% arrange(desc(drug), .by_group = FALSE)
...
compare_dss2_github_fimm <- subset(fmm_supplementary, select = c(Patient.num, drug, DSS2))
...
#Karolinska github ----
karolinska_github_fresh <- read_csv('~/Desktop/UiO/Project 1/Data/Initial cleansing/dss_github_karolinska_full_drug_set_fresh.csv')
karolinska_github_frosen <- read_csv('~/Desktop/UiO/Project 1/Data/Initial cleansing/dss_github_karolinska_full_drug_set_frosen.csv')
subset(karolinska_github_frosen, drug == 'Trifluridine' & Patient.num == 'AML_007')


karolinska_dss2_org <- read_csv('~/Desktop/UiO/Project 1/Data/Initial cleansing/karolinska_breese_output.csv')
...
compare_dss2_github_enserink <- subset(karolinska_github_fresh, select = c(Patient.num, drug, DSS2))
compare_dss2_github_enserink <- compare_dss2_github_enserink %>% arrange(desc(Patient.num), .by_group = FALSE)
compare_dss2_github_enserink <- compare_dss2_github_enserink %>% arrange(desc(drug), .by_group = FALSE)
...
compare_dss2_original_enserink <- subset(karolinska_dss2_org, sample == 'fresh',select = c(Patient.num, drug, DSS2))
compare_dss2_original_enserink <- compare_dss2_original_enserink %>% arrange(desc(Patient.num), .by_group = FALSE)
compare_dss2_original_enserink <- compare_dss2_original_enserink %>% arrange(desc(drug), .by_group = FALSE)
...
dss_github_beataml <- read_csv('~/Desktop/UiO/Project 1/Data/Initial cleansing/dss_github_beat_aml_full_drug_set.csv')
